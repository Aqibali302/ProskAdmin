...
import DocumentsAppointmentListTabel from "./DocumentsAppointmentListTabel";
...
function DocumentsAppointmentList() {
  ...
  function backbutton (){
    window.location = "#/ProskAdmin/AppointmentPatientList/";
  };
  
  function SendEmailToPatients (email,first_name,last_name) {
    // alert("relaoded");
    //let url="/WaveEdu/Institutions/F01LoadData";
    //let url="http://35.163.44.116:8080/ProskAdmin/SendEmailToPatients?email="+email;
    let url= localStorage.getItem("url") +"/ProskAdmin/SendEmailToPatients?email="+email;
    fetch(url, {
      method: "GET",
      //body: data
    })
  ...
  return (
    <div className={classes.root}> 
      <PrimaryAppBar header_text={"Documents"} />
...
export default DocumentsAppointmentList;
