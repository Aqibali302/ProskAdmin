...
class ShowAllConsentDocuments extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  Consent(filename){
      ...
      localStorage.setItem("file_name", filename);
        window.location = "#/ProskAdmin/ShowAllConsentDocumentsPDF";
  }
  handleMenu = (event) => {
...
export default withStyles(useStyles)(ShowAllConsentDocuments);
