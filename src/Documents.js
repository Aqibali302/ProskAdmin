...
class Documents extends React.Component {
    ...
    this.state = {
        ...
        AllergiesStatus: (
          <Typography variant="title" style={{ color: "yellow" }}>
                 <img src={loader} height="60px" width="70px" style={{marginRight:"19px"}} />
          </Typography>
        ),
        IDCardStatus: (
  ...
  handleListItemClick = (event) => {
    ...
    if(this.state.IDCard==true){
      console.log("ee");
      window.location = "#/ProskAdmin/ProvideIDCardDocuments";
        }else{
  ...
  handleListItemClick2 = (event) => {
    ...
    if(this.state.InsuranceCard==true){
      console.log("ee");
      window.location = "#/ProskAdmin/ProvideInsuranceCardDocuments";
        }else{
          console.log("Not Completed");
