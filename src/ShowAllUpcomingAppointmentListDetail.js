...
class ShowAllUpcomingAppointmentListDetail extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleListItemClick = (event) => {
    if(this.state.IDCard==true || this.state.InsuranceCard==true || this.state.Consect==true){
      console.log("ee");
      window.location = "#/ProskAdmin/Documents";
        }else{
      console.log("Not Completed");
      this.handleOpenSnackbar(<span> Documents is not completed by this patient </span>,
        "info"
    );
    }
  ...
  handleSurveyClick = (event) => {
    if(this.state.PMH==true){
      console.log("ee");
      window.location = "#/ProskAdmin/SurveyData";
        }else{
      console.log("Not Completed");
      this.handleOpenSnackbar(<span> Review of system is not completed by this patient </span>,
        "info"
    );
    }
  ...
  handlePMHClick = (event) => {
    if(this.state.PMH==true){
      console.log("ee");
      window.location = "#/ProskAdmin/MedicalHistory";
        }else{
      console.log("Not Completed");
      this.handleOpenSnackbar(<span> Medical History is not completed by this patient </span>,
        "info"
    );
    }
  ...
  handleMedicationsClick = (event) => {
    if(this.state.Medical==true){
      console.log("ee");
      window.location = "#/ProskAdmin/MedicationData";
        }else{
      console.log("Not Completed");
      this.handleOpenSnackbar(<span> Medication & Surgery is not completed by this patient </span>,
        "info"
    );
    }
  ...
  handleSurveyClick9 = (event) => {
    ...
    if(this.state.Survey==true){
      console.log("ee");
      window.location = "#/ProskAdmin/SurveyScore";
        }else{
      console.log("Not Completed");
      this.handleOpenSnackbar(<span> PROs Current Encounter is not completed by this patient </span>,
        "info"
    );
    }
  };
  ...
  handleListItemClickCare = (event) => {
    
    if(this.state.CarePhysician==true){
      console.log("ee");
      window.location = "#/ProskAdmin/PhysicianCareTeam";
        }else{
      console.log("Not Completed");
      this.handleOpenSnackbar(<span> Care Team is not yet provided by this patient </span>,
        "info"
    );
    }
  };
  ...
  handleMenu = (event) => {
    window.location = "#/ProskAdmin/UpcomingAppointmentsList";
  };
  handleListItemClickPROs = (event) => {
    if(this.state.Survey==true){
      console.log("ee");
      window.location = "#/ProskAdmin/PROsTrendAnalysis";
        }else{
          this.handleOpenSnackbar(<span> PROsTrendAnalysis is not completed by this patient </span>,
            "error"
        );
      console.log("Not Completed");
    }
  ...
  MobileCheckUserExists = (event) => {
   ...
   <img src={pend} height="60px" width="70px" style={{marginRight:"19px"}} />
       ...
       <img src={pend} height="60px" width="70px" style={{marginRight:"19px"}} />
            ...
            if ( result[0]["physician_id"]!=""||result[0]["physician_id"]!=null) {
              this.setState({
                CarePhysician:true,
                CarePhysiciansStatus: (
                  <Typography variant="title" style={{ color: "green" }}>
                 ...
                 <Card
                  ...
                  <Card
                    ...
                    >
                      <ListItem
                        button
                        onClick={(event) => this.handleListItemClickCare(event)}
                      >
                        <ListItemText>
                          <CardHeader
                            title={
                        ...
                        <ListItemSecondaryAction>
                          {this.state.CarePhysiciansStatus}
                        </ListItemSecondaryAction>
                      </ListItem>
                    </Card>
                    <Card
...
export default withStyles(useStyles)(ShowAllUpcomingAppointmentListDetail);
