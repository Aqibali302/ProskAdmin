...
//	  html +=" <a href='https://proskcloud.com/ProskAdminPatient/#/' ><img src='https://proskcloud.com/alpha/images/google.png' alt='' style='height:40px' /></a>";
//	   html +="</div>";
		...
		html +="<h4>Dear "+FirstName+" "+LastName+"</h4>";
		  html +="<p>Welcome to our practice.  Thank you for allowing us to serve your orthopedic needs. The following information is provided to ensure a smooth transition to our practice. Your upcoming appointment with Dr. Amer Mirza is on "+Date+" at "+Time+".<br><br>Please complete our intake forms online using the ProskAdmin� Patient Application available on Google Play or Apple Store.</br><br>To verify your login with this application we will use your cell phone; the number we have on record for you is "+phoneNum+". If this number is not correct, please call our office to correct it: 503-850-9940. Using thProskAdminsk� application will speed up the check-in process.</p>";
